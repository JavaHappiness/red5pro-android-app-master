 ...
 * 直播观看界面
 */
public class SubscribeActivity extends Activity implements ControlBarFragment.OnFragmentInteractionListener, SettingsDialogFragment.OnFragmentInteractionListener, View.OnClickListener {
    ...
    public final static String TAG = "SubscribeActivity";
