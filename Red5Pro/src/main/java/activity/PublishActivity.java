...
import helpClass.PublishStreamConfig;

/**
 * 推流界面
 */
public class PublishActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener,
    ...
    protected void beginStream() {
        ...
        isPublishing = true;
        stream.publish(PublishActivity.config.name, R5Stream.RecordType.Record);
    ...
    protected void configureStream(boolean startPreview) {
        ...
        final R5Configuration configuration = new R5Configuration(R5StreamProtocol.SIP, PublishActivity.config.host, PublishActivity.config.port, PublishActivity.config.app, 0.5f);
...
//                e.printStackTrace();
        ...
        if (selected_item != null) {
            ...
            if (r5Cam == null) {
                ...
                r5Cam.setBitrate(PublishActivity.config.bitrate);
            } else
