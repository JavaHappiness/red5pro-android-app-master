...
import fragment.ControlBarFragment;
 ...
 * 双模式
 */
public class TwoWayActivity extends PublishActivity implements SubscribeListFragment.Callbacks, SettingsDialogFragment.OnFragmentInteractionListener{
    ...
    protected SubscribeListFragment streamList;
    ...
    protected void goToStreamList(){
        ...
        final TwoWayActivity thisParent = this;
    ...
    protected void goToStreamView(){
        ...
        subStream = new R5Stream(new R5Connection(new R5Configuration(R5StreamProtocol.RTSP, PublishActivity.config.host,  PublishActivity.config.port, PublishActivity.config.app, 1.0f)));
